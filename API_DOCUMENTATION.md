...
**Formato del Excel:**
- ✅ **Encabezados**: Fondo negro, letra blanca, negrita, centrados
- ✅ **Celdas de datos**: Bordes negros, texto autoajustado
- ✅ **Anchos optimizados**: Columnas con anchos apropiados para cada tipo de dato
- ✅ **Alineación**: Texto centrado en encabezados, izquierda en datos
